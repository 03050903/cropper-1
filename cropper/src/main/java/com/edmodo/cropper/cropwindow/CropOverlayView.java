...
public class CropOverlayView extends View {
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            Edge.LEFT.setCoordinate(bitmapRect.left + horizontalPadding/2);
            Edge.TOP.setCoordinate(bitmapRect.top + verticalPadding * 3);
            Edge.RIGHT.setCoordinate(bitmapRect.right - horizontalPadding/2);
            Edge.BOTTOM.setCoordinate(bitmapRect.bottom - verticalPadding * 6);
        }
    }
